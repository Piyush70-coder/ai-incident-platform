...
# 1. LOCAL MODEL IMPORT (Ensure karna local_inference.py usi folder me ho)
...
def generate_root_cause(log_text: str) -> dict:
    ...
    print("🔴 Triggering Local Phi-3 Fallback Model on your Machine...")
    try:
        ...
        last_error = f"Groq failed and Local model also failed: {str(e)}"
        print(f"❌ {last_error}")
